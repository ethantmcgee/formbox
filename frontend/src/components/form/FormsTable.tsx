...
import {PageableApiForm, ApiForm} from '../../types';
      ...
      <div>
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-base font-semibold leading-6 text-gray-900">Manage Forms</h1>
            <p className="mt-2 text-sm text-gray-700">
              Create forms to receive submissions.  Enable form protection and configure notification settings.
            </p>
          </div>
                    ...
                    return (
                      <tr key={form.id}>
                        ...
                        <td className="whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-0">
                          <button type="button" className="text-indigo-600 hover:text-indigo-900 px-1" onClick={() => goToView(form)}>
                            View Submissions
                          </button>
                          <button type="button" className="text-indigo-600 hover:text-indigo-900 px-1" onClick={() => goToEdit(form)}>
                            Edit
                          </button>
                          <button type="button" className="text-indigo-600 hover:text-indigo-900 px-1" onClick={() => goToDelete(form)}>
                            Delete
                          </button>
                        </td>
                      </tr>
